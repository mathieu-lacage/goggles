...
SKIRT_SQUASHED_THICKNESS = SKIRT_THICKNESS * 0.6
...
LENS_CLIP_GROOVE_HEIGHT = 0.6
LENS_TOP_HEIGHT = 0.5
LENS_GROOVE_DEPTH = 1
LENS_BOTTOM_RING_WIDTH = 2*SKIRT_THICKNESS
LENS_INNER_RING_WIDTH = 1
LENS_GROOVE_HEIGHT = 1
LENS_BOTTOM_RING_HEIGHT = 0.8
LENS_VERTICAL_SQUASHINESS_OFFSET = SKIRT_THICKNESS-SKIRT_SQUASHED_THICKNESS
LENS_HORIZONTAL_SQUASHINESS_OFFSET = SKIRT_THICKNESS-SKIRT_SQUASHED_THICKNESS
LENS_RADIUS=0.2
LENS_HEIGHT = LENS_BOTTOM_RING_HEIGHT+LENS_CLIP_GROOVE_HEIGHT+LENS_TOP_HEIGHT+SHELL_THICKNESS+SKIRT_THICKNESS-LENS_VERTICAL_SQUASHINESS_OFFSET

SHELL_TOP_Y = -SHELL_THICKNESS
SHELL_TOP_X = LENS_BOTTOM_RING_WIDTH

SHELL_MIN_WIDTH = LENS_BOTTOM_RING_WIDTH
